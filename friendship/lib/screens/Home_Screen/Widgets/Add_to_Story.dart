...
import 'package:friendship/screens/Home_Screen/Widgets/Post_Story.dart';
class AddToStory extends StatefulWidget {
  const AddToStory({Key? key}) : super(key: key);
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Center(
                        child: Text('Add to Story',style: TextStyle(color: Color.fromRGBO(255, 255, 255, 1),
              ...
              itemBuilder: (BuildContext context, int index) {
                if (index == 0){
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      color: Color.fromRGBO(26, 26, 26, 1),
                      child: Center(child: Image.asset('assets/images/postimage.jpg',
